...
class AppColors {
  ...
  static const Color textMuted     = Color(0xFFADA0B5);
  ...
  static const Color sidebarBorder = Color(0xFFE8E2D8);
  ...
  static const Color emergencyCardBg = Color(0xFFFFEBEE);
  static const Color survivalCardBg  = Color(0xFFFFF3E0);
  static const Color analysisCardBg  = Color(0xFFF3E5F5);
}
